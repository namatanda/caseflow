...
CREATE TABLE "cases" (
    ...
    CONSTRAINT "cases_case_type_id_fkey" FOREIGN KEY ("case_type_id") REFERENCES "case_types" ("id") ON DELETE RESTRICT ON UPDATE CASCADE,
    CONSTRAINT "cases_original_court_id_fkey" FOREIGN KEY ("original_court_id") REFERENCES "courts" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);
...
CREATE TABLE "case_activities" (
    ...
    "other_details" TEXT,
    CONSTRAINT "case_activities_case_id_fkey" FOREIGN KEY ("case_id") REFERENCES "cases" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT "case_activities_import_batch_id_fkey" FOREIGN KEY ("import_batch_id") REFERENCES "daily_import_batches" ("id") ON DELETE RESTRICT ON UPDATE CASCADE,
    CONSTRAINT "case_activities_primary_judge_id_fkey" FOREIGN KEY ("primary_judge_id") REFERENCES "judges" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
CREATE TABLE "case_judge_assignments" (
    ...
    CONSTRAINT "case_judge_assignments_case_id_fkey" FOREIGN KEY ("case_id") REFERENCES "cases" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT "case_judge_assignments_judge_id_fkey" FOREIGN KEY ("judge_id") REFERENCES "judges" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
CREATE TABLE "daily_import_batches" (
    ...
    CONSTRAINT "daily_import_batches_created_by_fkey" FOREIGN KEY ("created_by") REFERENCES "users" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
CREATE TABLE "import_error_details" (
    ...
    CONSTRAINT "import_error_details_batchId_fkey" FOREIGN KEY ("batchId") REFERENCES "daily_import_batches" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
